...
namespace TCC.Classes.Base
{
    public class SensorKinect //KinectSensor
    {
        ...
        public void AnguloElevacao(int anguloElevacao)
        {
            ...
            {
                MessageBox.Show("Ocorreu um erro durante a execução, verifique se o sensor encontra-se conectado", "Erro", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        public void InicializarSensor()
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Verifique se o dispositivo kinect está conectado ao computador");

                }
            }
            catch (Exception erro)
            {
                MessageBox.Show(erro.Message, "Atenção", MessageBoxButton.OK, MessageBoxImage.Exclamation);
                return;
            }
        }
        #endregion
